...
//
	if (name == 'LONDON CLAY FORMATION - SAND') {name = name + '<br />THAMES GROUP'};	
	if (name == 'LONDON CLAY FORMATION - CLAY, SILT AND SAND') {name = name +'<br />THAMES GROUP'};
	if (name == 'LYTCHETT MATRAVERS SAND MEMBER - SAND') {name = 'LONDON CLAY FORMATION - SAND<br />(LYTCHETT MATRAVERS SAND MEMBER)<br />THAMES GROUP'};    
...
//
	if (name == 'PORTSDOWN CHALK FORMATION - CHALK') {name = name + '<br />WHITE CHALK SUBGROUP<br />CHALK GROUP'};	    
	if (name == 'SEAFORD CHALK FORMATION, NEWHAVEN CHALK FORMATION AND CULVER CHALK FORMATION (UNDIFFERENTIATED) - CHALK') {name = name + '<br />WHITE CHALK SUBGROUP<br />CHALK GROUP'};
	if (name == 'SPETISBURY CHALK MEMBER - CHALK') {name = name + '<br />CULVER CHALK FORMATION<br />WHITE CHALK SUBGROUP<br />CHALK GROUP'};
	if (name == 'TARRANT CHALK MEMBER - CHALK') {name = name + '<br />CULVER CHALK FORMATION<br />WHITE CHALK SUBGROUP<br />CHALK GROUP'};
	if (name == 'CULVER CHALK FORMATION - CHALK') {name = name + '<br />WHITE CHALK SUBGROUP<br />CHALK GROUP'};
	if (name == 'NEWHAVEN CHALK FORMATION - CHALK') {name = name + '<br />WHITE CHALK SUBGROUP<br />CHALK GROUP'};
	if (name == 'SEAFORD CHALK FORMATION - CHALK') {name = name + '<br />WHITE CHALK SUBGROUP<br />CHALK GROUP'};
	if (name == 'SEAFORD CHALK FORMATION AND NEWHAVEN CHALK FORMATION (UNDIFFERENTIATED) - CHALK') {name = name + '<br />WHITE CHALK SUBGROUP<br />CHALK GROUP'};
	if (name == 'LEWES NODULAR CHALK FORMATION - CHALK') {name = name + '<br />WHITE CHALK SUBGROUP<br />CHALK GROUP'};	    
	if (name == 'HOLYWELL NODULAR CHALK FORMATION - CHALK') {name = name + '<br />WHITE CHALK SUBGROUP<br />CHALK GROUP'};
	if (name == 'ZIG ZAG CHALK FORMATION - CHALK') {name = name + '<br />GREY CHALK SUBGROUP<br />CHALK GROUP'};
